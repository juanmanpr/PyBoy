...
from PyBoy.CPU.flags import flagZ, flagN, flagH, flagC
from ..Logger import logger
from PyBoy.CPU.Interrupts import InterruptVector, NoInterrupt
import numpy as np

class CPU(object): # 'object' is important for property!!!
    from PyBoy.CPU.opcodes import opcodes
    from PyBoy.CPU.registers import A, F, B, C, D, E, HL, SP, PC
    from PyBoy.CPU.registers import setH, setL, setAF, setBC, setDE
    from PyBoy.CPU.Interrupts import checkForInterrupts, testAndTriggerInterrupt
    from PyBoy.CPU.flags import VBlank, LCDC, TIMER, Serial, HightoLow
    from PyBoy.CPU.flags import testFlag, setFlag, clearFlag
    from PyBoy.CPU.flags import testInterruptFlag, setInterruptFlag, clearInterruptFlag, testInterruptFlagEnabled, testRAMRegisterFlag
